  ...
  return (
    <FooterStyle>
          ...
          <FooterCol
            ...
            links={[
              ...
              },
              {
                ...
                path:
                  'https://www.google.com/maps/@20.2699089,92.9810568,17.54z',
              },
            ]}
          />
        </div>
        <div className="footer__col4">
          <FooterCol
            ...
            links={[
              {
                title: 'Facebook',
                path: 'http://facebook.com/thant1009.zin',
              },
              {
                title: 'Twitter',
                path: 'http://twitter.com/thant1009.zin',
              },
              {
                title: 'Instagram',
                path: 'http://instagram.com/thant1009.zin',
              },
            ]}
          />
        </div>
      ...
      <div className="copyright">
        <div className="container">
          <PText>
            © 2022 - Than Zaw Aou | Designed By{' '}
            <a
              href="www.northernalliance.news"
              target="_blank"
              rel="noreferrer"
            >
              Arakkha
